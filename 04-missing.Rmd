...
Here we will firstly look at the missing pattern of detailed shooting data for NBA Regular Season 2019-20. After getting the data out, here we firstly have a look at the head of data: 
```{r GET_request}
