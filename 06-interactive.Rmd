...
By looking at all data, we obtain the same conclusion as before, which is that players shoot less mid-range than 3-points and layups. Another interesting observation is that, not many 3-point shots are made at left and right corners, but the field goal percentage is similar within different 3-point zones.
