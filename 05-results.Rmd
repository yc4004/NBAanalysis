...
```
Firstly, to get a general understanding of how many 2-point and 3-point shots each team made for season 2020-21, we create a Cleveland Dot Plot as follows:
...
shot_data %>%
  ...
  geom_point()+
  labs(title = "Cleveland Dot Plot for Shooting Counts for each Team", x = "count", y = "Team Name")
```
