...
1. (On team level)
Does each team has different preference for 2 point shots and 3 point shots or shots in different zones? Does their field goal percentage affect the preference?
...
After getting a general understanding of types and shots attempted for each team, now we want to focus on Field Goal Percentage ($\frac{\text{ total shots made}}{\text{total shots attempted}}$).
