...
shot_data %>%
  ...
  ggtitle("Alluvial Diagram of Shooting Behavior of Steph Curry")+
  theme(legend.position="bottom",legend.title = element_text(size=5), legend.text = element_text(size=5))+
  ylab('Frequence')
```

Based on this alluvial diagram, we could see that Stephen Curry in this season attempted more 3 pointers and two thirds of his shots happened more than 24 feet away from the basket. As a right-handed player, it seems like that he does not have preference on which side to shoot. However, after comparing the shot attempted at left side center and right side center, we could see that in the left side center, his shooting percentage is slightly lower. 
